...
public class Assignment1 {
    ...
    public static void employee() {
        int pan; // instance variable storing pan number
        String name; // instance variable storing name
        Double taxincome; // instance variable storing taxable income
        Double tax; // instance variable storing tax amount that is calculated
        ...
        if (taxincome < 100000) {
            ...
            Double tax = taxincome * 0.05;
        } else if (taxincome >= 150001 && taxincome < 250000) {
            Double tax = taxincome * 0.2;
        } else if (taxincome >= 250000) {
            Double tax = taxincome * 0.3;
        }
